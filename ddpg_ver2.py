...
from utils import ddpg_compute_critic_loss, ddpg_compute_actor_loss, soft_update, hard_update
...
class Agent:
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        # Replay memory
        self.memory = AgentMemory(BUFFER_SIZE, BATCH_SIZE, random_seed)
    ...
    def learn(self, experiences, gamma):
        ...
        critic_loss = ddpg_compute_critic_loss(states, actions, rewards, next_states, dones, GAMMA,
                                               self.actor_target, self.critic_target, self.critic_local)
        # Minimize the loss
        ...
        actor_loss = ddpg_compute_actor_loss(states, self.actor_local, self.critic_local)
        # Minimize the loss
